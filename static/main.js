...
function increaseNumber() {
  var numComment = parseInt(commentNumber.innerHTML, 10) + 1;
...
function _sendComment() {
  _sendComment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(comment) {
    var videoId, url, response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // console.log(comment);
            videoId = document.URL.split("/videos/")[1];
...
/* harmony import */ var _addComment_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addComment.js */ "./assets/js/addComment.js");
...
var fullScreenBtn = document.querySelector("#jsFullScreenButton");
...
function registerView() {
  try {
    var videoId = document.URL.split("videos/")[1];
...
var formatDate = function formatDate(seconds) {
  ...
  var hrs = Math.floor(secondNumber / 3600);
  var min = Math.floor(secondNumber % 3600 / 60);
  var sec = secondNumber % 60;
  return ("0" + hrs).slice(-2) + ":" + ("0" + min).slice(-2) + ":" + ("0" + sec).slice(-2);
};
...
function toggleFullScreenClick() {
  if (!document.fullscreenElement) {
    videoContainer.requestFullscreen().then(function () {
      ...
      return console.error("You can't get a full screen: ".concat(error));
    });
  } else {
...
module.exports = __webpack_require__(/*! /home/dannykim/Documents/youtube-clone-2020/assets/js/main.js */"./assets/js/main.js");
